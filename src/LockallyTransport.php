 ...
 *
 * Laravel 9+ mail is built on Symfony Mailer, so registering this transport via
 * Mail::extend('lockally', ...) makes `Mail::mailer('lockally')`, queued mail,
 * notifications and mailables all route through Lockally with no other changes.
 */
final class LockallyTransport extends AbstractTransport
{
    ...
    {
        return 'lockally://api.lockally.com';
    }
}
